...
HDA_14_draws <- read.csv("~/Trophic_Cascade_Warming_Submission/Fitting/HDA_14_Lognormal_liklihood/HDA_14_draws_iter.csv")
HDA_14_draws$Temp <- 14 # ADD TEMP TREATMENT 

HDA_17_draws <- read.csv("~/Trophic_Cascade_Warming_Submission/Revision Files/HDA_17_Lognormal_liklihood/HDA_17_draws_iter.csv")
HDA_17_draws$Temp <- 17 # ADD TEMP TREATMENT 

HDA_20_draws <- read.csv("~/Trophic_Cascade_Warming_Submission/Revision Files/HDA_20_Lognormal_liklihood/HDA_20_draws_iter.csv")
HDA_20_draws$Temp <- 20 # ADD TEMP TREATMENT 

HDA_23_draws <- read.csv("~/Trophic_Cascade_Warming_Submission/Revision Files/HDA_23_Lognormal_liklihood/HDA_23_draws_iter.csv")
HDA_23_draws$Temp <- 23 # ADD TEMP TREATMENT 

HDA_26_draws <- read.csv("~/Trophic_Cascade_Warming_Submission/Revision Files/HDA_26_Lognormal_liklihood/HDA_26_draws_iter.csv")
