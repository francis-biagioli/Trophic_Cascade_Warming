...
```{r}
HDA_14_trace <- rstan::traceplot(HDA_14_fit, pars = c("r", "Q", "a1", "h1", "w1","a2", "e2", "d2", "h2", "w2", "sd_obs1", "sd_obs2", "log_sd_obs3", "N1_0", "N2_0", "N3_0"), inc_warmup = TRUE)

ggsave("HDA_14_trace.png", HDA_14_trace, width =10 , height = 7, dpi = 200)
```

```{r}
HDA_17_trace <- rstan::traceplot(HDA_17_fit, pars = c("r", "Q", "a1", "h1", "w1","a2", "e2", "d2", "h2", "w2", "sd_obs1", "sd_obs2", "log_sd_obs3", "N1_0", "N2_0", "N3_0"), inc_warmup = TRUE)

ggsave("HDA_17_trace.png", HDA_17_trace, width =10 , height = 7, dpi = 200)
```

```{r}
HDA_20_trace <- rstan::traceplot(HDA_20_fit, pars = c("r", "Q", "a1", "h1", "w1","a2", "e2", "d2", "h2", "w2", "sd_obs1", "sd_obs2", "log_sd_obs3", "N1_0", "N2_0", "N3_0"), inc_warmup = TRUE)

ggsave("HDA_20_trace.png", HDA_20_trace, width =10 , height = 7, dpi = 200)
```

```{r}
HDA_23_trace <- rstan::traceplot(HDA_23_fit, pars = c("r", "Q", "a1", "h1", "w1","a2", "e2", "d2", "h2", "w2", "sd_obs1", "sd_obs2", "log_sd_obs3", "N1_0", "N2_0", "N3_0"), inc_warmup = TRUE)

ggsave("HDA_23_trace.png", HDA_23_trace, width =10 , height = 7, dpi = 200)
```

```{r}
HDA_26_trace <- rstan::traceplot(HDA_26_fit, pars = c("r", "Q", "a1", "h1", "w1","a2", "e2", "d2", "h2", "w2", "sd_obs1", "sd_obs2", "log_sd_obs3", "N1_0", "N2_0", "N3_0"), inc_warmup = TRUE)
