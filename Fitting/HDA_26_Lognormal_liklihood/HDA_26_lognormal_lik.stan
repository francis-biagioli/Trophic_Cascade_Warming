///////////////////////////////////////////////////////////////////////////////////////
////////////////////////// STAN CODE FOR THREE SPECIES JARS 26C /////////////////////////
///////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////// DEFINE PARAMETERS TO BE ESTIMATED BY SOLVER /////////////////////////
 ...
 real<lower = 0> log_sd_obs3; //std dev of hydra on log scale
...
model {
  ...
  r ~ normal(2.046415e-01, 4.671682e-02); //DA_26
  
  Q ~ normal(2.163617e-07, 9.024294e-08); //DA_26
  
  a1 ~ normal(5, 3);
  
  h1 ~ normal(1.542272e-05, 4.279144e-06); //DA_26
  
  w1 ~ normal(1.579123e+00, 7.030910e-01); //DA_26
  
  //w1 ~ normal(8.439199e+00, 6.842676e+00); //increased older value
