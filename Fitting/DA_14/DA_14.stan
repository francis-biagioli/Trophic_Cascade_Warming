///////////////////////////////////////////////////////////////////////////////////////
////////////////////////// STAN CODE FOR TWO SPECIES JARS 14C /////////////////////////
///////////////////////////////////////////////////////////////////////////////////////
...
model {
  ...
  r ~ normal(4.802530e-02, 9.223840e-03); 
  
  Q ~ normal(3.541385e-07, 2.720056e-07);

  a1 ~ normal(2.026618e-01, 1.194885e-01);
  
  e1 ~ normal(5.617132e-04, 2.862119e-04); 
  
  d1 ~ normal(2.380208e+00, 6.504642e-01);
  
  h1 ~ normal(1.908917e-04, 9.561157e-05); 

  w1 ~ normal(2.463522e+00, 3.527207e-01);

  B ~ normal (2.326068e-02, 2.264046e-02);
